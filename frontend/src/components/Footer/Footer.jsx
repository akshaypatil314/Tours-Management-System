            ...
            <Container>
                <Row>
                    <Col lg="3">
                        <div className="logo">
                            <img src={logo} alt='' />
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut dicta reiciendis.</p>
                    ...
                    <Col lg="3">
                        ...
                        <ListGroup className='footer__quick-links'>
                            ...
                            <ListGroupItem className='ps-0 border-0 d-flex align-items-center'>
                                ...
                                <p className='mb-0'> Kalyan,Mumbai</p>
                            </ListGroupItem>
                            ...
                            <ListGroupItem className='ps-0 border-0 d-flex align-items-center'>
                                ...
                                <p className='mb-0'>Jonh@gmail.com</p>
                            </ListGroupItem>
